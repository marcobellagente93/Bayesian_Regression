...
<img src="https://render.githubusercontent.com/render/math?math=L(\theta) = \frac{1}{2 \hat{\sigma}_i^2} |\textbf{y}_i - \textbf{\hat{y}}_i|_{L2} \quad + \frac{1}{2} \log \hat{\sigma}_i^2">
