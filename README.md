...
In order to capture epistemic uncertainty in a neural network we can place a prior over its parameters <img src="https://latex.codecogs.com/gif.latex?\small&space;\theta&space;\sim&space;\mathcal{N}(\mu,&space;\sigma)" title="\small \theta \sim \mathcal{N}(\mu, \sigma)" />
